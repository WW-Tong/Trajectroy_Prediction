# 轨迹预测相关资源与文献
Version_1.0      	LastUpdated 2022.4.29
...
|                           数据集                            |            包含目标            |         场景         |       传感器         |
| :----------------------------------------------------------: | :--------------------------: | :-----------------------: | :--------------------: |
|      [INTERACTION](http://www.interaction-dataset.com/)      | 车辆 / 自行车/ 行人  | 环形交叉路口 / 十字路口 |     相机     |
|        [KITTI](http://www.cvlibs.net/datasets/kitti/)        | 车辆 / 自行车/ 行人  |   公路 / 乡郊   |     相机 / 激光雷达     |
|           [HighD](https://www.highd-dataset.com/)            |           车辆           |          公路          |         相机         |
| [NGSIM](https://ops.fhwa.dot.gov/trafficanalysistools/ngsim.htm) |           车辆           |          公路          |         相机         |
| [自行车](http://www.gavrila.net/Datasets/Daimler_Pedestrian_Benchmark_D/Tsinghua-Daimler_Cyclist_Detec/tsinghua-daimler_cyclist_detec.html) |           自行车           |           都市           |         相机         |
|            [nuScenes](https://www.nuscenes.org/)             |           车辆           |           都市           | 相机 / 激光雷达 / 雷达 |
|          [BDD100k](https://bdd-data.berkeley.edu/)           | 车辆 / 自行车 / 行人 |      公路 / 都市      |         相机         |
| [Apolloscapes](http://apolloscape.auto/?source=post_page---------------------------) | 车辆 / 自行车 / 行人 |           都市           |         相机         |
| [Udacity](https://github.com/udacity/self-driving-car/tree/master/datasets) |           车辆           |           都市           |         相机         |
|      [Cityscapes](https://www.cityscapes-dataset.com/)       |       车辆/ 行人       |           都市           |         相机         |
| [Stanford Drone](http://cvgl.stanford.edu/projects/uav_data/) | 车辆 / 自行车/ 行人  |           都市           |         相机         |
|           [Argoverse](https://www.argoverse.org/)            |      车辆 / 行人       |           都市           |     相机 / 激光雷达     |
| [TRAF](https://gamma.umd.edu/researchdirections/autonomousdriving/trafdataset)            |      车辆/自行车/ 行人/动物       |           都市           |     相机      |
|[Lyft Level 5](https://level5.lyft.com/dataset/)               | 车辆/自行车/行人     | 都市                     | 相机/ 激光雷达   |
|[Aschaffenburg Pose Dataset](https://doi.org/10.5281/zenodo.5724486)               |    自行车/行人     |           都市           |         相机         |

### 行人

|                           Dataset                            |           Agents            |       Scenarios       |    Sensors     |
| :----------------------------------------------------------: | :-------------------------: | :-------------------: | :------------: |
| [UCY](https://graphics.cs.ucy.ac.cy/research/downloads/crowd-data) |           行人            |    Zara / 学生    |     相机     |
|       [ETH (ICCV09)](https://icu.ee.ethz.ch/research/datsets.html)       |           行人            |         都市         |     相机     |
|              [VIRAT](http://www.viratdata.org/)              |      行人 / 车辆      |         都市         |     相机     |
|        [KITTI](http://www.cvlibs.net/datasets/kitti/)        | 车辆 / 自行车/ 行人 | 公路 / 乡郊 | 相机 / 激光雷达 |
|     [ATC](https://irc.atr.jp/crest2010_HRI/ATC_dataset/)     |           行人            |    购物中心    |  距离传感器  |
| [Daimler](http://www.gavrila.net/Datasets/Daimler_Pedestrian_Benchmark_D/daimler_pedestrian_benchmark_d.html) |           行人            |  车流  |     相机     |
| [Central Station](http://www.ee.cuhk.edu.hk/~xgwang/grandcentral.html) |           行人            |    车站内      |     相机     |
| [Town Center](http://www.robots.ox.ac.uk/ActiveVision/Research/Projects/2009bbenfold_headpose/project.html#datasets) |           行人            |     都市街道      |     相机     |
| [Edinburgh](http://homepages.inf.ed.ac.uk/rbf/FORUMTRACKING/) |           行人            |         都市         |     相机     |
|   [Cityscapes](https://www.cityscapes-dataset.com/login/)    |      车辆/ 行人       |         都市         |     相机     |
|           [Argoverse](https://www.argoverse.org/)            |      车辆 / 行人      |         都市         | 相机 / 激光雷达 |
| [Stanford Drone](http://cvgl.stanford.edu/projects/uav_data/) | 车辆 / 自行车/ 行人 |         都市         |     相机     |
|           [TrajNet](http://trajnet.stanford.edu/)            |           行人            |         都市         |     相机     |
|           [PIE](http://data.nvision2.eecs.yorku.ca/PIE_dataset/)            |           行人            |         都市         |     相机     |
|           [ForkingPaths](https://next.cs.cmu.edu/multiverse/index.html)            |           行人            |         都市 / 仿真         |     相机     |
|           [TrajNet++](https://www.aicrowd.com/challenges/trajnet-a-trajectory-forecasting-challenge)            |           行人            |         都市         |     相机     |
|[Aschaffenburg Pose Dataset](https://doi.org/10.5281/zenodo.5724486)               |    自行车/行人     |           都市           |         相机         |
### 运动员

|                           Dataset                            | Agents |     Scenarios     | Sensors |
| :----------------------------------------------------------: | :----: | :---------------: | :-----: |
|     [Football](https://datahub.io/collections/football)      | 运动员 |  足球场   | 相机  |
| [NBA SportVU](https://github.com/linouk23/NBA-Player-Movements) | 运动员 |  篮球馆  | 相机  |
|      [NFL](https://github.com/a-vhadgar/Big-Data-Bowl)       | 运动员 | 橄榄球场 | 相机  |

以上数据在使用时为视频、雷达数据的追踪文件，一般为文本形式，其中必有的属性为：帧编号-目标编号-目标位置x-目标位置y,不同的数据集可能有其他附加属性，如目标类别、框体坐标等
